...
- (void)testCreationWithLinguisticSyntaxWord {
    ...
    JTSyntaxLinguisticWord *linguisticWord = [[JTSyntaxLinguisticWord alloc] initWithText:textualWord inRange:NSMakeRange(0, textualWord.length) useSuggestions:YES isCurrentlyWritingWord:NO textInputMode:[self mockedTextInputMode]];
...
- (void)testCreationWithSeperationSyntaxWord {
    ...
    JTSyntaxSeperatorWord *seperatorWord = [[JTSyntaxSeperatorWord alloc] initWithText:textualWord inRange:NSMakeRange(0, textualWord.length) useSuggestions:YES isCurrentlyWritingWord:NO textInputMode:[self mockedTextInputMode]];
